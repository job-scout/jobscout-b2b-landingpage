...
function Banner() {
	return (
		<div className=" bg-gradient-to-b from-primary via-primary/95 to-primary/75">
			<div className=" text-white h-[90vh] lg:h-[86vh] 2xl:h-[90vh] flex items-center justify-between container mx-auto px-4 lg:w-[80%] 2xl:w-[80%] space-x-12 ">
